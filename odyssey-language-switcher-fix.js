(function(){
  ...
  function mount(){
    ...
    const headerSlot = document.querySelector('nav [data-i18n-switcher], header [data-i18n-switcher], .topbar [data-i18n-switcher], .nav-right [data-i18n-switcher]');
    const header = headerSlot || document.querySelector('nav .nav-right, header .nav-right, nav, header, .topbar');
    if(header){
