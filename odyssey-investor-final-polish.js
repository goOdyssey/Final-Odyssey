(function(){
  ...
  const LANDING_KEYS = {
    ...
    ar:{reg_title2:'استعدادك.', reg_tag:'📝 الاختبارات والمسابقات', reg_title1:'اختبارك. بلدك.', reg_body:'اختبارات القبول وشهادات اللغة والأولمبيادات والمسابقات — كلها في مكان واحد.'},
    fa:{reg_title2:'آمادگی شما.', reg_tag:'📝 آزمون‌ها و رقابت‌ها', reg_title1:'آزمون شما. کشور شما.', reg_body:'آزمون‌های ورودی، گواهی‌های زبان، المپیادها و رقابت‌ها — همه در یک جا.'}
  };
